...
import { Box, Typography, Button, TextField, Avatar, Select, MenuItem, FormControl, InputLabel, Autocomplete, CircularProgress } from '@mui/material';
...
export default function SubCategoryList() {
    ...
    return (
        ...
        >
            <DataTable key={`subcategory-table-${paginationModel.page}-${paginationModel.pageSize}`} columns={columns} state={tableState} handlers={tableHandlers} />
        </ListPageLayout>
    );
}
